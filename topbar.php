      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item ">
          <div class="d-flex position-relative">
            <p class="text-primary position-absolute" style="top:-25px"></p>
          </div>
          <div></div>
        </li>
      <?php endif; ?>
        <li>
        <a class="nav-link text-white" href="./" role="button"> <large><b>KIndonesia</b></large></a>
        </li>
      </ul>
      ...
      <?php endif; ?>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                <a class="dropdown-item" href="index.php?page=profile"><i class="fa fa-id-card"></i> Profile</a>
