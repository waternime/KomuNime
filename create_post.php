...
<div class="container-fluid">
	<form action="" id="manage_post">
		...
		<div class="form-group">
			<textarea name="content" id="content" cols="30" rows="2" class="form-control" placeholder="Apa yang ada dipikiranmu, <?php echo ucwords($_SESSION['login_firstname']) ?>?" style="resize:none;border: none"><?php echo isset($content) ? $content : '' ?></textarea>
		</div>
		<div class="c-row" id="">
