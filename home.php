					...
					<div class="card-body">
						<div class="container-fluid">
							<div class="d-flex w-100">
				                ...
				                <button class="btn btn-default ml-4 text-left" id="write_post" type="button" style="width:calc(80%);border-radius: 50px !important;"><span>Apa yang ada di pikiranmu, <?php echo ucwords($_SESSION['login_firstname']) ?>?</span></button>
							</div>
							<hr>
